...
inline
typename std::enable_if<!KernelTraits<_Kernel_Ty_>::has_transpose>::type
symm_eval(const _Kernel_Ty_& K,
...
symm_eval(const _Kernel_Ty_& K,
          ...
          const Target& p2, const Charge& c2, Result& r2)
{
  typedef typename KernelTraits<_Kernel_Ty_>::kernel_value_type kernel_value_type;
...
inline void
block_eval(const _Kernel_Ty_& K,
