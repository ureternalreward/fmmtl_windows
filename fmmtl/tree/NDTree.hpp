...
public:
  ...
  using box_iterator = CountedProxyIterator<Box, const fmmtl::NDTree<DIM>, size_type>;
  using body_iterator = CountedProxyIterator<Body, const  fmmtl::NDTree<DIM>, size_type>;
