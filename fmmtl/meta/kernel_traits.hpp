...
struct KernelTraits {
 public:
  typedef KernelTraits<_Kernel_Ty_>                    self_type;
  ...
  static const bool has_eval_op = HasEvalOp<_Kernel_Ty_>::value;
  // Kernel transpose, K.transpose(K(t,s))
  HAS_MEM_FUNC(HasTranspose,
               kernel_value_type, transpose,
               const kernel_value_type&);
  static const bool has_transpose = HasTranspose<_Kernel_Ty_>::value;
 ...
 public:
  ...
  static const bool has_vector_S2T_symm = HasS2Tsymm<_Kernel_Ty_>::value;
  HAS_MEM_FUNC(HasS2Tasymm,
               void, S2T,
               source_iterator, source_iterator, charge_iterator,
               target_iterator, target_iterator, result_iterator);
  static const bool has_vector_S2T_asymm = HasS2Tasymm<_Kernel_Ty_>::value;
